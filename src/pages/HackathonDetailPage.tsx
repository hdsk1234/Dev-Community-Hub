...
export const HackathonDetailPage = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Evaluation Section */}
      <Section title="평가 기준" icon={Award}>
      ...
      {/* Schedule Section */}
      <Section title="일정" icon={Calendar}>
        <div className="space-y-4">
      ...
      {/* Teams Section */}
      <Section title="팀" icon={Users}>
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <p className="text-slate-500 font-medium">참여 팀 ({teams.length})</p>
            <button 
      ...
      {/* Leaderboard Section */}
      <Section title="리더보드" icon={BarChart3}>
